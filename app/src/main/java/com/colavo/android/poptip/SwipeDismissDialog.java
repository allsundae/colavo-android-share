...
public class SwipeDismissDialog extends FrameLayout {
 ...
 //       setBackgroundColor(params.overlayColor);
        ...
        layoutParams.windowAnimations = R.style.mydialog_animation; //android.R.style.Animation_Translucent;
        ...
        public boolean onTouch(View view, MotionEvent motionEvent) {
            ...
            switch (action) {
                ...
                case MotionEvent.ACTION_MOVE: {
                    ...
                    float scale = 1- (rotationAngle/35) ;
 /*                 view.setScaleX(scale);
                ...
                case MotionEvent.ACTION_UP: {
                    ...
                    PropertyValuesHolder alphaAnimation =
                            PropertyValuesHolder.ofFloat("alpha", 1f);
                    ObjectAnimator originBackAnimation =
                            ObjectAnimator.ofPropertyValuesHolder(view, horizontalAnimation,
                                    verticalAnimation, rotateAnimation, alphaAnimation);
                    originBackAnimation.setInterpolator(
                            new OvershootInterpolator()); // AnticipateOvershootInterpolator());// AccelerateDecelerateInterpolator());
                    originBackAnimation.setDuration(600);
